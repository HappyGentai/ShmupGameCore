    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            if (action.bindings[bindingIndex].isPartOfComposite)
                partName = LocalizationManager.Localize("Menu.Control_Binding", action.bindings[bindingIndex].name);
            ...
            if (m_RebindText != null)
            {
                ...
                var isNullOrEmptyFalse = LocalizationManager.Localize("Menu.Control_Wait", partName);
            ...
            foreach(InputBinding binding in action.actionMap.bindings)
            {
                ...
                if (binding.action == newBinding.action)
                {
                    if (binding.isPartOfComposite && (currentIndex != bindingIndex))
                    {
                        ...
                        {
                            var duplicateText = LocalizationManager.Localize("Menu.Control_Duplicate", newBinding.effectivePath);
        ...
        private void UpdateActionLabel()
        {
            if (m_ActionLabel != null)
            {
                ...
                {
                    m_ActionLabel.text = LocalizationManager.Localize(m_ActionLabelString);
                } else
                {
