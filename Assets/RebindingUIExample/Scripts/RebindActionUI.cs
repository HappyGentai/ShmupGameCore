            ...
            foreach(InputBinding binding in action.actionMap.bindings)
            {
                ...
                if (binding.action == newBinding.action)
                {
                    if (binding.isPartOfComposite && (currentIndex != bindingIndex))
                    {
                        ...
                        {
                            var duplicateText = "Duplicate binding found in composite:" + newBinding.effectivePath;
                ...
                if (binding.effectivePath == newBinding.effectivePath)
                {
                    var duplicateText = "DuplicateBinding found: " + newBinding.effectivePath;
                    m_DuplicateText.enabled = true;
                    m_DuplicateText.text = duplicateText;
                    return true;
                }
            ...
            */
            if (allCompositeParts)
            {
                for (int index = 1; index < bindingIndex; ++index)
                {
                    ...
                    {
                        Debug.Log("B-DuplicateBinding found: " + newBinding.effectivePath);
                        return true;
                    }
                }
            }
